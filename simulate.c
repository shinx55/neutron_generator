...
#define MAX_DECAY_MODE DECAY_MODE_DOUBLE_ELECTRON_CAPTURE
...
extern void initAtomProperties()
{
	...
	if(e_atomPropertyPtr){
		...
		initDecayMode4(53, 110, DECAY_MODE_BETA_PLUS, 83.0 - 1.09, DECAY_MODE_ALPHA, 17.0, DECAY_MODE_BETA_PLUS_PROTON, 11.0, DECAY_MODE_BETA_PLUS_ALPHA);
